...
function loadScene(
  ...
  filenameToLinkPromise.then(filenameToLink => {
    ...
    let occupancyGridBlockSizes = [8, 16, 32, 64, 128]; //let occupancyGridBlockSizes = [ 16, 32, 64, 128, 256];
...
function initFromParameters() {
  ...
  if (size) {
    ...
    }  // else assume  is 'high' and render at full res.
  }
  ...
  const nearPlane = parseFloat(params.get('near') || 0.05);
