...
THREE.OrbitControls = function ( object, domElement ) {
	...
	// The four arrow keys
	this.keys = { LEFT: 37, UP: 38, RIGHT: 39, BOTTOM: 40, W: 87, S: 83, A: 65, D: 68, R: 82, F: 70 };
	...
	this.btnControlsTimer;
	this.btnControls = function(key){
		if(!key){
			clearInterval(btnControlsTimer);  
			return;
		}

		switch (key) {
			case 'w':
				btnControlsTimer = setInterval(function() {  
					dollyOut( getZoomScale() );
				}, 100);
				break;
			case 's':
